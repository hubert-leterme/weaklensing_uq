...
srun python -u scripts/create_augmented_dataset.py -o $HOME/work/Data/kappaTNG_processed/calib/LP001_augmented_brightfaint_384.hdf5 --idx-lp 1 --angle-batch-size 5 --angle-step 8 --cosmos-include-faint -w 5 --seed 42 -v
