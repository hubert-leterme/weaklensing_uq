...
srun python -u scripts/create_augmented_dataset.py -o $HOME/work/Data/kappaTNG_processed/trainval/LP002_augmented_zbins_384.hdf5 --idx-lp 2 -z --angle-batch-size 8 --angle-step 1 --niter-per-angle 2 -w 8 --seed 42 -v
