...
PATH_TO_KTNG_TRAINING_SET = os.path.expanduser(
    CONFIG_DATA.get('path_to_ktng_training_set', None)
)
PATH_TO_KTNG_TEST_SET = os.path.expanduser(
    CONFIG_DATA.get('path_to_ktng_test_set', None)
)
